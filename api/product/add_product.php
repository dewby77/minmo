...
$product = initProduct(null, $product_number, $product_name, $new_name, $product_status_id);

if ($new_product_id = insertProduct($product)){   
    $success_count++;
} else {
    $error_count++;
}
...
if($success_count > 0 && !$no_files){
    $static_target = '..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'product_img'.DIRECTORY_SEPARATOR.$new_product_id;
