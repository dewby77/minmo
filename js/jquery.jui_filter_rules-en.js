...
var rsc_jui_fr = {
    ...
    rules_group_AND: "AND conditions", //McCrea - all rules is confusing, this will use AND for conditions
    //rules_group_OR: "any rule",
    rules_group_OR: "OR conditions",   //McCrea - all rules is confusing, this will use OR for conditions
    ...
    rule_insert_inside: "insert rule", //McCrea - insert inside is confusing, this will add a new rule
    rule_clear: "clear",
    rule_delete: "delete",
    group_insert_before: "insert before",
    group_insert_after: "insert after",
    //group_insert_inside: "insert inside",
    group_insert_inside: "insert group", //McCrea - insert inside is confusing, this will add a new group
    group_delete: "delete",
